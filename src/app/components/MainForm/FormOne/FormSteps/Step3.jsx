    ...
    <section>
      ...
      <div className="w-[661px] mx-auto">
        ...
        <form onSubmit={handleSubmit}>
            ...
            {isFormError && (
              <div className="mt-1">
                <p className="uppercase text-red-600 text-[12px] tracking-[0.08333em]">
                  You can only choose the current date or tomorrow as the
                  selected date
                </p>
              </div>
            )}
          ...
          {/* error message if have any start */}

          {isError && (
            <div className="flex justify-start gap-3 p-4 rounded-md border border-red-600 bg-red-100 mt-5">
              <BsInfoCircle className="w-12 h-12 text-red-600 " />
              <small className="text-[12px] leading-4 text-justify  text-uptext">
                {" "}
